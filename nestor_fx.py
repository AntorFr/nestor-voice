...
- skippy : baryton "canette" -> boitier metal + comb + choeur + bitcrush
  -> ring-mod 90 Hz @ 45%. Validee le 2026-07-05 (robot-A).
"""
...
PROFILES = {
    ...
    # --- Skippy : baryton "canette", metal facon IA Elder (robot-A) ---
    "skippy": VoiceFX(

...
| `SKIPPY_LENGTH_SCALE` | `""` | **vide = le `.onnx.json` décide** (le débit voyage avec le modèle). Renseigner (>1 = plus lent) seulement pour forcer un débit sans changer de modèle |
